...
--
-- Table structure for table `character_warband_groups`
--

DROP TABLE IF EXISTS `character_warband_groups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `character_warband_groups` (
  ...
  PRIMARY KEY (`groupId`),
  KEY `idx_battlenet_account_id` (`battlenetAccountId`,`orderIndex`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `character_warband_group_members`
--

DROP TABLE IF EXISTS `character_warband_group_members`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `character_warband_group_members` (
  `groupId` bigint unsigned NOT NULL,
  `memberIndex` int unsigned NOT NULL DEFAULT '0',
  ...
  CONSTRAINT `fk_character_warband_group_members__group` FOREIGN KEY (`groupId`) REFERENCES `character_warband_groups` (`groupId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
