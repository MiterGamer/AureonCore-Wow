...
INSERT INTO `playerchoice` (`ChoiceId`, `UiTextureKitId`, `SoundKitId`, `CloseSoundKitId`, `Duration`, `Question`, `PendingChoiceText`, `InfiniteRange`, `HideWarboardHeader`, `KeepOpenAfterChoice`, `ShowChoicesAsList`, `VerifiedBuild`) VALUES
(974, 263, 0, 0, NULL, 'Which story would you like to hear?', '', 0, 0, 0, 0, 65940);

UPDATE `playerchoice` SET `InfiniteRange`=0, `HideWarboardHeader`=0, `KeepOpenAfterChoice`=0, `ShowChoicesAsList`=0, `VerifiedBuild`=65940 WHERE `ChoiceId`=845;
