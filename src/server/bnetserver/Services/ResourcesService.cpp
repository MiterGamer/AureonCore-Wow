...
{
Resources::Resources(Session* session) : ResourcesService(session)
{
}

uint32 Resources::HandleGetContentHandle(::bgs::protocol::resources::v1::ContentHandleRequest const* request,
...
uint32 Resources::HandleGetTitleIcons(::bgs::protocol::resources::v1::GetTitleIconsRequest const* /*request*/,
