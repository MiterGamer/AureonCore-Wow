...
class TC_GAME_API WorldSession
{
    ...
    public:                                                 // opcodes handlers
        ...
        void Handle_ClientAcknowledged(WorldPackets::Null& null); // consume client packet, no retail logic yet
        void Handle_EarlyProccess(WorldPackets::Null& null); // just mark packets processed in WorldSocket::ReadDataHandler
        void HandleFetchBleepProxies(WorldPackets::Misc::FetchBleepProxies& packet);
        ...
        void HandleHousingClientOpcode(WorldPackets::Null& packet);
        ...
        void HandleOpenTradeskillNpc(WorldPackets::NPC::OpenTradeskillNpc& packet);
        void HandleRequestMythicPlusSeasonData(WorldPackets::Null& packet);
        void HandleRequestMythicPlusAffixes(WorldPackets::Null& packet);
        void HandleRequestWeeklyRewards(WorldPackets::Null& packet);
        void HandleGetCharacterCurrencyTransferLog(WorldPackets::Null& packet);
        void HandleGetLandingPageShipments(WorldPackets::Null& packet);
        void HandleRequestScheduledPvpInfo(WorldPackets::Null& packet);
        void HandlePerksProgramStatusRequest(WorldPackets::Null& packet);
        void HandlePerksProgramRequestPurchase(WorldPackets::Misc::PerksProgramRequestPurchase& packet);
        void HandleStartChallengeMode(WorldPackets::Misc::StartChallengeMode& packet);
        void HandleResetChallengeMode(WorldPackets::Null& packet);
        void HandleClaimWeeklyReward(WorldPackets::Misc::ClaimWeeklyReward& packet);
        void HandleLfgListGetStatus(WorldPackets::Null& packet);
        void HandleRequestLfgListBlacklist(WorldPackets::Null& packet);
