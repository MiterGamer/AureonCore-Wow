...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_ACCEPT_SOCIAL_CONTRACT,                             STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_ACCOUNT_NOTIFICATION_ACKNOWLEDGED,                  STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_ADDON_LIST,                                         STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_BLEEP_PONG,                                         STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_DISCARDED_TIME_SYNC_ACKS,                           STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_EXPIRE_BLEEP_TOKENS,                                STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_GET_ACCOUNT_CHARACTER_LIST,                         STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    DEFINE_HANDLER(CMSG_GET_ACCOUNT_NOTIFICATIONS,                          STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_GET_CHARACTER_CURRENCY_TRANSFER_LOG,                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGetCharacterCurrencyTransferLog);
    ...
    DEFINE_HANDLER(CMSG_GET_LAST_CATALOG_FETCH,                             STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_GET_RAF_ACCOUNT_INFO,                               STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_GET_REMAINING_GAME_TIME,                            STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_HOUSE_EXTERIOR_LOCK,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSE_EXTERIOR_SET_HOUSE_POSITION,                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSE_INTERIOR_LEAVE_HOUSE,                         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_BLUEPRINT_DELETE,                           STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_BLUEPRINT_EXPORT,                           STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_BLUEPRINT_IMPORT,                           STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_BLUEPRINT_RENAME,                           STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_BLUEPRINT_REQUEST_COLLECTION,               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_BLUEPRINT_REQUEST_CONTENTS,                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_DELETE_FROM_STORAGE,                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_LOCK,                                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_MOVE,                                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_PLACE,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_REDEEM_DEFERRED_DECOR,                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_REMOVE,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_REQUEST_STORAGE,                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_SET_DYE_SLOTS,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_SET_EDIT_MODE,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_SET_PET,                              STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_CREATE_FIXTURE,                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_DELETE_FIXTURE,                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_SET_CORE_FIXTURE,                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_SET_EDIT_MODE,                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_SET_HOUSE_SIZE,                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_SET_HOUSE_TYPE,                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_GET_CURRENT_HOUSE_INFO,                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_GET_PLAYER_PERMISSIONS,                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_HOUSE_STATUS,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_PHOTO_SHARING_CLEAR_AUTHORIZATION,          STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_PHOTO_SHARING_COMPLETE_AUTHORIZATION,       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_RESET_HOUSE,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_RESET_KIOSK_MODE,                           STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_ADD,                                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_APPLY_COMPONENT_MATERIALS,             STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_MOVE,                                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_REMOVE,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_ROTATE,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_SET_CEILING_TYPE,                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_SET_COMPONENT_THEME,                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_SET_DOOR_TYPE,                         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_SET_LAYOUT_EDIT_MODE,                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_ACCEPT_NEIGHBORHOOD_OWNERSHIP,         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_DELETE_ALL_NEIGHBORHOOD_INVITES,       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_GET_BNET_FRIEND_NEIGHBORHOODS,         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_GET_HOUSE_FINDER_INFO,                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_GET_HOUSE_FINDER_NEIGHBORHOOD,         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_GET_PLAYER_HOUSES_INFO,                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_GET_POTENTIAL_HOUSE_OWNERS,            STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_GUILD_CREATE_NEIGHBORHOOD,             STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_HOUSE_FINDER_IGNORE_NEIGHBORHOOD,      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_NEIGHBORHOOD_RESERVE_PLOT,             STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_PLAYER_VIEW_HOUSES_BY_BNET_ACCOUNT,    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_PLAYER_VIEW_HOUSES_BY_PLAYER,          STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_REJECT_NEIGHBORHOOD_OWNERSHIP,         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_RELINQUISH_HOUSE,                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_START_TUTORIAL,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_TELEPORT_TO_PLOT,                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_UPDATE_HOUSE_SETTINGS,                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleHousingClientOpcode);
    ...
    DEFINE_HANDLER(CMSG_LFG_LIST_GET_STATUS,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleLfgListGetStatus);
    ...
    DEFINE_HANDLER(CMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST,             STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_MOVE_SET_TURN_RATE_CHEAT,                           STATUS_IGNORED,   PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    ...
    DEFINE_HANDLER(CMSG_OVERRIDE_SCREEN_FLASH,                              STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_PERKS_PROGRAM_REQUEST_PURCHASE,                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePerksProgramRequestPurchase);
    ...
    DEFINE_HANDLER(CMSG_QUERY_QUEST_ITEM_USABILITY,                         STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::HandleQueryQuestItemUsability);
    ...
    DEFINE_HANDLER(CMSG_QUICK_JOIN_AUTO_ACCEPT_REQUESTS,                    STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_REFRESH_BLEEP_TOKENS,                               STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_REQUEST_INSTANCE_ENCOUNTER_EVENT_SYNC,              STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_REQUEST_SCHEDULED_PVP_INFO,                         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestScheduledPvpInfo);
    ...
    DEFINE_HANDLER(CMSG_REQUEST_WEEKLY_REWARDS,                             STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestWeeklyRewards);
    ...
    DEFINE_HANDLER(CMSG_SETUP_WARBAND_GROUPS,                               STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_SET_EXCLUDED_CHAT_CENSOR_SOURCES,                   STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
    ...
    DEFINE_HANDLER(CMSG_UPDATE_LAST_CATALOG_FETCH,                          STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_ClientAcknowledged);
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_HOUSING_BLUEPRINT_CHECK_RESPONSE,                             STATUS_NEVER,       CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_HOUSING_BLUEPRINT_GET_RESPONSE,                               STATUS_NEVER,       CONNECTION_TYPE_REALM);
