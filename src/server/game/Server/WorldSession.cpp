...
void WorldSession::Handle_ClientAcknowledged(WorldPackets::Null& null)
{
    TC_LOG_DEBUG("network.opcode", "Acknowledged unimplemented opcode {} from {}", GetOpcodeNameForLogging(null.GetOpcode()), GetPlayerInfo());
}

void WorldSession::HandleFetchBleepProxies(WorldPackets::Misc::FetchBleepProxies& /*packet*/)
{
    WorldPackets::Misc::FetchBleepProxiesResponse response;
