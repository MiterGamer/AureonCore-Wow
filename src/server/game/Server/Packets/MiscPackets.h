...
namespace WorldPackets
{
    namespace Misc
    {
        ...
        {
        public:
            explicit MythicPlusCurrentAffixes() : ServerPacket(SMSG_MYTHIC_PLUS_CURRENT_AFFIXES, 8) { }
        ...
        public:
            ...
            int32 SeasonID = 0;
            uint32 NextReset = 0;
            std::vector<WeeklyRewardEntry> Rewards;
        };
        ...
        struct LandingPageShipment
        {
            uint32 PlotInstanceID = 0;
            uint32 BuildingID = 0;
        };

        class LandingPageShipmentsResponse final : public ServerPacket
        {
        public:
            explicit LandingPageShipmentsResponse() : ServerPacket(SMSG_GET_LANDING_PAGE_SHIPMENTS_RESPONSE, 8) { }

            WorldPacket const* Write() override;

            std::vector<LandingPageShipment> Shipments;
        };

        class ScheduledPvpInfoResponse final : public ServerPacket
        {
        public:
            explicit ScheduledPvpInfoResponse() : ServerPacket(SMSG_REQUEST_SCHEDULED_PVP_INFO_RESPONSE, 12) { }
        ...
        {
        public:
            explicit PerksProgramDisabled() : ServerPacket(SMSG_PERKS_PROGRAM_DISABLED, 0) { }
        ...
        public:
            ...
            std::vector<WorldPackets::PerksProgram::PerksVendorItem> Items;
        };

        class PerksProgramResult final : public ServerPacket
        {
        public:
            explicit PerksProgramResult() : ServerPacket(SMSG_PERKS_PROGRAM_RESULT, 8) { }
        ...
        {
        public:
            explicit ChallengeModeStart() : ServerPacket(SMSG_CHALLENGE_MODE_START, 32) { }
        ...
        {
        public:
            explicit ChallengeModeComplete() : ServerPacket(SMSG_CHALLENGE_MODE_COMPLETE, 20) { }

            WorldPacket const* Write() override;

            int32 ChallengeModeID = 0;
            int32 DurationMS = 0;
            int32 KeystoneLevel = 0;
            bool Timed = false;
        };
        ...
        {
        public:
            explicit WeeklyRewardClaimResult() : ServerPacket(SMSG_WEEKLY_REWARD_CLAIM_RESULT, 12) { }
