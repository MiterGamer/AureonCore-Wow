...
namespace WorldPackets::Housing
{
    ...
    // Minimal reply so the client unblocks. Layout is not fully documented; keep this tiny.
    class EmptyResult final : public ServerPacket
    {
    public:
        explicit EmptyResult(OpcodeServer opcode) : ServerPacket(opcode, 8) { }
