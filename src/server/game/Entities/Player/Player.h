...
class TC_GAME_API Player final : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void SetSeasonalContentFields(uint32 weeklyPeriod, WorldPackets::MythicPlus::DungeonScoreSummary const& summary, WorldPackets::MythicPlus::DungeonScoreData const& data);
        void SetChallengeModeState(UF::ChallengeModeData const& data);
        void ClearChallengeModeState();
        void SetPerksProgramCurrency(int32 amount);
        int32 GetPerksProgramCurrency() const { return *m_activePlayerData->PerksProgramCurrency; }
