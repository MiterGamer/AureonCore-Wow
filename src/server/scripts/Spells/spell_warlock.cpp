...
class spell_warl_deaths_embrace : public SpellScript
{
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        // SPELL_WARLOCK_DEATHS_EMBRACE (453189) does not exist in this DBC build
        return true;
    }
...
class spell_warl_devour_magic : public SpellScript
{
    bool Validate(SpellInfo const* spellInfo) override
    {
        // SPELL_WARLOCK_GLYPH_OF_DEMON_TRAINING (56249) does not exist in this DBC build
...
class spell_warl_seduction : public SpellScript
{
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        // SPELL_WARLOCK_GLYPH_OF_SUCCUBUS (56250) does not exist in this DBC build
