...
class spell_evo_call_of_ysera : public SpellScript
{
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        // Spells 373834, 373835 do not exist in this DBC build
        return true;
    }
...
class spell_evo_fire_breath_damage : public SpellScript
{
    bool Validate(SpellInfo const* spellInfo) override
    {
        // Spell 357209 does not have EFFECT_2 in this DBC build - skip effect validation
        return true;
    }
...
class spell_evo_permeating_chill : public AuraScript
{
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        // SPELL_EVOKER_PERMEATING_CHILL_TALENT (370897) does not exist in this DBC build
        return true;
    }
...
class spell_evo_snapfire : public SpellScript
{
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        // SPELL_EVOKER_SNAPFIRE (370818) does not exist in this DBC build
        return true;
    }
