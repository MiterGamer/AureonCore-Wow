...
class spell_warr_powerful_enrage : public SpellScript
{
    bool Validate(SpellInfo const* spellInfo) override
    {
        // Spell 184362 may not have expected effects in this DBC build - skip strict validation
...
class spell_warr_improved_whirlwind_cleave : public SpellScript
{
    bool Validate(SpellInfo const* spellInfo) override
    {
        // Spell 85739 may not have expected effects in this DBC build - skip strict validation
        return true;
    }
...
class spell_warr_sweeping_strikes : public AuraScript
{
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        // Spells 12723, 26654 do not exist in this DBC build - skip validation
        return true;
    }
