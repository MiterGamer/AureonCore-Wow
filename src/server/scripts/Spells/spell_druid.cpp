...
class spell_dru_eclipse_aura : public AuraScript
{
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        // Spells 326053, 326055, 79577 do not exist in this DBC build - skip validation
        return true;
    }
...
class spell_dru_eclipse_dummy : public AuraScript
{
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        // Spells 326053, 326055 do not exist in this DBC build - skip validation
        return true;
    }
...
class spell_dru_inner_peace : public SpellScript
{
    bool Validate(SpellInfo const* spellInfo) override
    {
        // Spell 740 does not have EFFECT_3/EFFECT_4 in this DBC build - skip effect validation
...
public:
    bool Validate(SpellInfo const* spellInfo) override
    {
        // Spell 450347 does not have EFFECT_2 in this DBC build - skip effect validation
