...
enum FreezingCircleMisc
{
    ...
    // SPELL_FREEZING_CIRCLE_PIT_OF_SARON_HEROIC = 70276, // removed - spell does not exist in DBC
...
class spell_freezing_circle : public SpellScript
{
        ...
        return ValidateSpellInfo(
            {
                ...
                // SPELL_FREEZING_CIRCLE_PIT_OF_SARON_HEROIC, // removed - spell does not exist in DBC
    ...
    void HandleDamage(SpellEffIndex /*effIndex*/)
    {
        ...
        if (map->IsDungeon())
            spellId = SPELL_FREEZING_CIRCLE_PIT_OF_SARON_NORMAL; // was: heroic check, but heroic spell removed
        else
